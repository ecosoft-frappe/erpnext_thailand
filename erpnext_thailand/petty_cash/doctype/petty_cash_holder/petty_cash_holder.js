					...
					frappe.prompt(
						[
							...
							},
							{
								...
								reqd: 1,
								default: Math.max(
									frm.doc.petty_cash_float - frm.doc.petty_cash_balance,
									0
								),
							},
						],
										...
										callback: function (r) {
											if (r.message) {
												frappe.msgprint({
													title: __("Success"),
													message: __(
														`The petty cash holder has received the top up successfully.<br><br>Journal Entry Reference: <a href="/app/journal-entry/` +
															r.message.name +
															`" "><b>` +
															r.message.name +
															`</b></a>`
										...
										callback: function (r) {
											if (r.message) {
												frappe.msgprint({
													title: __("Success"),
													message: __(
														`The petty cash holder has completed the withdrawal successfully.<br><br>Journal Entry Reference: <a href="/app/journal-entry/` +
															r.message.name +
															`" "><b>` +
															r.message.name +
															`</b></a>`
